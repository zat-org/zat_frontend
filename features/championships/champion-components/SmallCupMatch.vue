<template>
    <article
        class="flex w-full max-w-[360px] items-center justify-between gap-2 overflow-hidden rounded-lg border border-surface-tone2 bg-surface-overlay px-3 py-2"
        dir="rtl"
    >
        <div class="flex min-w-0 flex-1 items-center gap-2">
            <div class="flex size-6 shrink-0 items-center justify-center overflow-hidden rounded-sm bg-surface-overlay">
                <Image
