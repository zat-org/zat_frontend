<template>
    <article class="overflow-hidden rounded-zat-md border border-surface-tone2 bg-surface-raised"
        ...
        <header class="flex h-17 items-center justify-end gap-2 bg-nav-bar px-4" dir="ltr">
            <div class="min-w-48">
                <USelectMenu
                    v-model="selectedId"
                    :items="options"
...
import type { IStatisticViewData } from '~/features/championships/types/StatisticOption'
