<template>
    ...
    >
        <section
            class="flex h-full max-h-180 w-full flex-col overflow-hidden rounded-zat-md border-2 border-surface-tone2 bg-surface-raised xl:max-h-190"
        ...
        >
            ...
            <!-- Type tabs -->
            <div
                class="flex h-13 w-full shrink-0 items-center gap-4 overflow-x-auto border-b-2 border-surface-primary bg-nav-bar px-4 pt-4 sm:gap-6 sm:px-6"
            >
                <button
...
import type { IMatchHistoryChamp, IMatchHistoryParams } from '~/features/matches/types/IMatchHistory'
