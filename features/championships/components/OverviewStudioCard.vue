<template>
    ...
    >
        ...
        <div class="relative z-10 flex items-center gap-6" dir="ltr">
            <div class="relative aspect-video w-full min-w-0 flex-1 overflow-hidden rounded-zat-sm bg-surface-raised">
                <img
                    v-if="thumbnail"
                    :src="thumbnail"
...
import { extractYoutubeVideoId, youtubeThumbnailUrl } from '~/features/shared/utils/youtube'
