    ...
    <FetchDataWrapper class="md:w-5/6 lg:w2/3 mx-auto"
        ...
        <div class="flex justify-between items-center my-5">
            <div class="flex">
                ...
                <UButton
                    class="fixed bottom-5 left-5  h-12 w-32 animate-bounce transition-all rounded-full flex justify-center items-center"
                    @click="isFormOpen = true">
                    <span>ارسل
                        بياناتك الان</span>
                    <UIcon name="i-heroicons-inbox" class="text-5xl" />
                </UButton>
            </div>
            <UButton to="/jobs" class="absolute left-5 h-12 rounded-full w-12 md:w-32 transition-all text-center"
                :trailing="true">
