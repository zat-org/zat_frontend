        ...
        <div class="container px-5 py-10 mx-auto">
            ...
            <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
                <div class="p-4 md:w-1/3 flex flex-col text-center items-center">
                    <div
                        class="w-20 h-20 inline-flex items-center justify-center rounded-full bg-amber-100 text-amber-500 mb-5 flex-shrink-0">
            ...
            <button
                class="btn flex mx-auto mt-16 text-white bg-amber-500 border-0 py-2 px-8 focus:outline-none hover:bg-amber-600 rounded text-lg">Button</button>
        </div>
    </section>
    <!-- contact us -->
</template>
