<template>
    <div>
        <template v-if="!pending && !error && champs">
            <section class="mb-20" v-if="champs.length > 0">
                <div class="flex flex-wrap w-full mb-2">
                    <div class="lg:w-1/2 w-full mb-6 lg:mb-0">
                        <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">البطولات الحالية</h1>
