<template>
    <article
        class="group relative   flex h-72 w-full max-w-102.5 flex-col items-center justify-center gap-2 overflow-hidden rounded-zat-md bg-white px-8 py-10 transition-colors duration-300 sm:px-16"
        :class="[
            isExpanded ? 'bg-white' : 'hover:bg-[#D0D0D0]',
        ]"
        dir="rtl"
