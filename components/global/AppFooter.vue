    ...
    <footer
        ...
        <div class=" flex justify-around my-5 ">
            ...
            <a class="mx-2 w-10 h-10 bg-gray-300 rounded-full flex justify-center items-center hover:-translate-y-1 duration-300 transition-all"
                href="https://t.snapchat.com/eA4bzp8e" target="_blank">
            ...
            <a class="mx-2 w-10 h-10 bg-gray-300 rounded-full flex justify-center items-center hover:-translate-y-1 duration-300 transition-all"
                href="https://www.tiktok.com/@sam_3b?_t=8gGRSJ84IPi&_r=1" target="_blank">
            ...
            <a class="mx-2 w-10 h-10 bg-gray-300 rounded-full flex justify-center items-center hover:-translate-y-1 duration-300 transition-all"
                href="https://x.com/pioneer_but?s=21&t=MJVi6_aLTIU6Cqing6xDhw" target="_blank">
