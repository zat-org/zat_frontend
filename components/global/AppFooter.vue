<template>
    <footer
        class="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300 flex flex-col md:flex-row justify-center items-center md:justify-between ">
        <div class="items-center grid-flow-col">
            ...
            <p>سام لبطولات البلوت الاحترافية<br />نوفر مواد ترفيهية منذ عام 2020</p>
        </div>
