<template>
    ...
    <div class="flex justify-evenly">
        <div class="py-2 px-4 rounded-md flex flex-col justify-center items-center"
            ...
            <UInput type="number" name="team1Score" v-model="team1Score" class="w-24" label=""
                placeholder="2" :min="0" :max="2" :integer="true" />
        </div>
        <div class="py-2 px-4 rounded-md flex flex-col justify-center items-center"
            ...
            <Image class="bg-white my-2" :src="`${url}${match.team2.logo}`" :alt="match.team2.name"
                icon="i-heroicons-users" />
            <UInput type="number" name="team2Score" v-model="team2Score" class="w-24" label=""
                placeholder="1" :min="0" :max="2" :integer="true" />
        </div>
    </div>
