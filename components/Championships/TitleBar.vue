        ...
        <div class="page-container flex items-center justify-between gap-4 py-4">
            <div class="flex min-w-0 items-center gap-2">
                <NuxtLink
                    ...
                    :aria-label="`العودة إلى ${typePageTitle}`"
                >
...
const typeConfig = computed(() => getChampionshipTypeConfig(props.champ.type))

const typePageTitle = computed(() => getChampionshipTypePageTitle(props.champ.type))

const typeHref = computed(() => typeConfig.value?.to ?? '/championships')
