<template>
    ...
    >
        ...
        <!-- Type tabs -->
        <div
            class="flex h-[52px] w-full items-center gap-4 overflow-x-auto border-b-2 border-surface-primary bg-[#343232] px-4 pt-4 sm:gap-6 sm:px-8 lg:px-[var(--spacing-page)]"
        >
            <button
...
import type { IMatchHistoryChamp, IMatchHistoryParams, MatchHistoryStatus } from '@/Models/IMatchHistory'
